...
import {getAllFeedbackController, getUserController, getUsersController} from "../controllers/userController";
...
adminRoute.get("/getAllFeedback",authMiddleware,getAllFeedbackController);
